...
export default function Signup({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Simple mock authentication for signup
    if (name && email && password) {
      onLogin(name); // Treat as logged in right away with name
    }
  };
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100vw' }}>
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '40px', borderRadius: '24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', textAlign: 'center' }}>Join AuraBank to manage your finances seamlessly.</p>
        </div>
